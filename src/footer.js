            ...
            <div className="px-6 pt-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-14 lg:px-14">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-3 lg:max-w-sm">
                            <p className="text-sm text-gray-500">
                                Farm Tech revolutionizes food distribution by directly connecting farmers with consumers, delivering fresh produce straight from the farm to your doorstep. Our platform ensures fair prices for farmers and offers buyers a convenient way to access locally sourced, high-quality products.
                            </p>
                        </div>
                    </div>
                    <div className="space-y-2 text-sm">
                        <p className="text-2xl font-bold  tracking-wide text-green-500">Contacts</p>
                        <div className="flex">
                            <p className="mr-1  text-green-500 ">Phone:</p>
                            <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className=" text-gray-500">042-9845656</a>
                        </div>
                        <div className="flex">
                            <p className="mr-1 text-green-500">Email:</p>
                            <a href="mailto:Farmtech@lorem.mail" aria-label="Our email" title="Our email" className="text-gray-500">farmTech@lorem.mail</a>
                        </div>
                        <div className="flex">
                            <p className="mr-1 text-green-500">Address:</p>
                    ...
                    <div className="mt-6 md:mt-8">
                        ...
                        <p className="mt-4 text-sm text-gray-500">
                            A convenient way to access locally sourced, high-quality products. With a focus on sustainability and efficiency, Farm Tech is transforming the agricultural industry for the better.
                        </p>
                    </div>
                </div>
                <div className="flex flex-col-reverse justify-between  pb-10 border-t lg:flex-row">
                ...
                <div>
                    <button
                        ...
                        onClick={goToTop}
                        title="Go To Top"
                        className={`fixed z-50 bottom-10 right-10 p-4 border-0 w-14 h-14 rounded-full shadow-md bg-green-500 ${showButton ? 'visible' : 'invisible'} hover:bg-gray-400 text-white text-lg font-semibold transition-colors duration-300`}
                    >
